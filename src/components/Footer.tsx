...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    if (footerRef.current && textRef.current && iconsRef.current) {
      ...
      iconsRef.current.querySelectorAll("a").forEach((icon) => {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative w-full bg-linear-to-t from-gray-950 via-black to-gray-950
                 py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-8
                 border-t border-gray-800/50
                 overflow-hidden"
    >
      {/* Efectos de fondo */}
      <div className="absolute inset-0 bg-linaer-to-b from-transparent via-fuchsia-900/5 to-transparent" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <a
            ...
            className="group p-3 sm:p-4 rounded-full bg-linaer-to-br from-gray-900 to-black
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            Desarrollado con{" "}
            <FaHeart className="inline-block mx-1 text-fuchsia-500 animate-pulse" />
        ...
        <div className="my-6 sm:my-8">
          <div className="h-px w-full bg-linaer-to-r from-transparent via-gray-700 to-transparent" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-8">
          ...
          <div className="text-center sm:text-right">
            <p className="text-xs text-gray-500">
              <span className="text-gray-300">v1.0</span> • Última
              actualización: {currentYear}
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="lg:hidden fixed bottom-20 right-4 sm:right-6 z-50 w-10 h-10 sm:w-12 sm:h-12
                   bg-linaer-to-br from-cyan-600/90 to-fuchsia-600/90
