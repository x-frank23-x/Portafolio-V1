...
const SkillsComponent = () => {
  ...
  const technologies = [
    {
      ...
      detailedDescription: 'Biblioteca JavaScript para construir interfaces de usuario. Usada en la remodelación del sitio web de E&P Profesionales y desarrollo desde cero de Induracks.',
      category: 'Frontend',
      level: 'Avanzado',
      projects: [
    ...
    },
    {
      ...
      image: 'https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg',
      detailedDescription: 'Framework para construir aplicaciones móviles nativas usando React. Experiencia en desarrollo de apps multiplataforma.',
      category: 'Mobile',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Framework para aplicaciones web de una sola página. Experiencia en desarrollo de aplicaciones tipo CRUD con consumo de APIs.',
      category: 'Frontend',
      level: 'Básico',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'UI toolkit de Google para apps móviles nativas. Usado en el desarrollo de aplicaciones móviles multiplataforma.',
      category: 'Mobile',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Lenguaje versátil para backend y automatización. Implementado en Supersalud para creación de inventarios automatizados y optimización de flujos de trabajo.',
      category: 'Backend',
      level: 'Avanzado',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Framework moderno para construir APIs con Python. Parte del stack tecnológico para desarrollo de backend eficiente.',
      category: 'Backend',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Entorno de ejecución de JavaScript para backend. Usado en automatización de tareas y desarrollo de APIs.',
      category: 'Backend',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Superset de JavaScript con tipado estático. Implementado en proyectos React para mayor seguridad y mantenibilidad.',
      category: 'Frontend',
      level: 'Avanzado',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Lenguaje principal para desarrollo web frontend y backend. Usado en todos los proyectos web como tecnología base.',
      category: 'Lenguajes',
      level: 'Avanzado',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Lenguaje de programación orientado a objetos. Experiencia en desarrollo de aplicaciones empresariales.',
      category: 'Backend',
      level: 'Básico',
      projects: [
...

    {
      ...
      detailedDescription: 'Lenguaje usado con Flutter para desarrollo móvil. Implementado en aplicación móvil para administración del equipo deportivo Mallorca.',
      category: 'Mobile',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Sistema de gestión de bases de datos relacionales. Usado como solución preferencial para modelado relacional y persistencia de datos.',
      category: 'Database',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Sistema de gestión de bases de datos popular. Parte del stack tecnológico para desarrollo de aplicaciones web.',
      category: 'Database',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Sistema de control de versiones distribuido. Fundamental en todos los proyectos para colaboración y control de versiones.',
    ...
    },
    {
      ...
      detailedDescription: 'Plataforma de contenedorización para aplicaciones. Usada en pruebas técnicas para configuración controlada de entornos.',
      category: 'Herramientas',
      level: 'Intermedio',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Framework CSS utility-first. Implementado en E&P Profesionales e Induracks para interfaces modernas, responsivas y consistentes.',
      category: 'Frontend',
      level: 'Avanzado',
      projects: [
    ...
    },
    {
      ...
      detailedDescription: 'Plataforma para desarrollo de apps móviles y web. Implementada junto a Flutter en la aplicación Mallorca para autenticación y datos en tiempo real.',
      category: 'Backend',
      level: 'Intermedio',
      projects: [
  ...
  const getRelatedProjects = (techName: string) => {
    switch(techName) {
      ...
      case 'TypeScript':
        return [
          { name: 'E&P Profesionales', type: 'Remodelación Web', description: 'Sitio web renovado con mejoras de rendimiento y sistema de contacto' },
          { name: 'Induracks', type: 'Desarrollo Web', description: 'Sitio web desde cero para empresa de estanterías industriales' }
        ];
      case 'Python':
        return [
          { name: 'Supersalud', type: 'Automatización', description: 'Sistema automatizado de inventarios y optimización de flujos de trabajo' }
        ];
      case 'Flutter':
      case 'Dart':
      case 'Firebase':
        return [
          { name: 'Mallorca', type: 'Aplicación Móvil', description: 'App para administración de equipo deportivo con autenticación y datos en tiempo real' }
        ];
      case 'Angular':
      case 'C#':
        return [
          { name: 'Proyecto CRUD', type: 'Aplicación Empresarial', description: 'Desarrollo de aplicación tipo CRUD con consumo de APIs y formularios reactivos' }
        ];
      default:
        return [
          { name: 'Proyectos Profesionales', type: 'Desarrollo Full Stack', description: 'Implementado en diversos proyectos empresariales y aplicaciones' }
        ];
    }
  };
  ...
  return (
      <div
          ...
          className="relative w-full min-h-screen flex flex-col items-center justify-center
                 ...
                 overflow-hidden bg-gradient-to-b from-transparent to-gray-950/50"
      >
        {/* Efectos de fondo */}
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-900/5 via-transparent to-fuchsia-900/5" />
        ...
        {!isMobile ? (
            <div className="relative z-10 flex items-center justify-center w-full">
              ...
              >
                {/* Centro del círculo */}
                <div className="absolute w-24 h-24 md:w-28 md:h-28
                          bg-gradient-to-br from-cyan-900/80 to-fuchsia-900/80
                    ...
                    return (
                        <div
                            ...
                            style={{
                              ...
                              borderColor: hoveredTech === tech.name ? 'rgb(34 211 238 / 0.5)' : 'rgba(255, 255, 255, 0.1)',
                              transformOrigin: '0% 0%',
                        ...
                        >
                          ...
                          ${tech.level === 'Avanzado' ? 'bg-green-500' :
                                  tech.level === 'Intermedio' ? 'bg-yellow-500' :
                                      'bg-blue-500'}
                        `} />
                            </div>
                          </div>
                          ...
                          {hoveredTech === tech.name && (
                              <div className="absolute bottom-full mb-3 p-2 bg-gray-900/90
        ...
        {selectedTech && (
            <>
              ...
              {/* Panel del modal */}
              <div className={`
            modal-panel fixed z-50 bg-gradient-to-br from-gray-900 to-gray-950
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="px-2 py-1 bg-gray-800 text-gray-300
                                     text-xs rounded-full">
                        {selectedTech.category}
                      </span>
                          <span className={`
                        px-2 py-1 text-xs rounded-full
                        ${selectedTech.level === 'Avanzado' ? 'bg-green-900/30 text-green-300' :
                              selectedTech.level === 'Intermedio' ? 'bg-yellow-900/30 text-yellow-300' :
                  ...
                  <div className="mb-6">
                    <h4 className="text-gray-400 text-sm font-medium mb-2">Descripción</h4>
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-4 mb-4">
                    <h4 className="text-gray-400 text-sm font-medium mb-3">Experiencia en Proyectos</h4>
                    <ul className="space-y-3">
                      {getRelatedProjects(selectedTech.name).map((project, index) => (
                          <li key={index} className="text-gray-300 text-sm">
                            <div className="flex items-start">
                              <span className="text-cyan-400 mr-2">•</span>
                              <div>
                                <div className="font-medium text-cyan-300">{project.name}</div>
                                <div className="text-gray-400 text-xs mt-1">{project.type}</div>
                                <div className="text-gray-300 text-xs mt-1">{project.description}</div>
                              </div>
                            </div>
                          </li>
                      ))}
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-4">
                    <h4 className="text-gray-400 text-sm font-medium mb-2">Tecnologías Relacionadas</h4>
                    <div className="flex flex-wrap gap-2">
                      {selectedTech.name === 'React' && (
                          <>
                            <span className="px-2 py-1 bg-blue-900/30 text-blue-300 text-xs rounded-full">TypeScript</span>
                            <span className="px-2 py-1 bg-teal-900/30 text-teal-300 text-xs rounded-full">Tailwind CSS</span>
                            <span className="px-2 py-1 bg-cyan-900/30 text-cyan-300 text-xs rounded-full">React Native</span>
                          </>
                      )}
                      {selectedTech.name === 'Python' && (
                          <>
                            <span className="px-2 py-1 bg-teal-900/30 text-teal-300 text-xs rounded-full">FastAPI</span>
                            <span className="px-2 py-1 bg-green-900/30 text-green-300 text-xs rounded-full">Excel</span>
                          </>
                      )}
                      {selectedTech.name === 'Flutter' && (
                          <>
                            <span className="px-2 py-1 bg-blue-900/30 text-blue-300 text-xs rounded-full">Dart</span>
                            <span className="px-2 py-1 bg-yellow-900/30 text-yellow-300 text-xs rounded-full">Firebase</span>
                          </>
                      )}
                      {selectedTech.name === 'Angular' && (
                          <>
                            <span className="px-2 py-1 bg-purple-900/30 text-purple-300 text-xs rounded-full">C#</span>
                            <span className="px-2 py-1 bg-red-900/30 text-red-300 text-xs rounded-full">Java</span>
                          </>
                      )}
                    </div>
                  </div>
        ...
        {!isMobile && !selectedTech && (
            <div className="mt-12 flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 z-20">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 text-sm">Avanzado - Proyectos Profesionales</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-yellow-500" />
                <span className="text-gray-300 text-sm">Intermedio - Experiencia Significativa</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-blue-500" />
                <span className="text-gray-300 text-sm">Básico - Conocimiento Fundamental</span>
              </div>
            </div>
        )}

        {/* Información contextual con proyectos reales */}
        <div className="mt-8 sm:mt-12 md:mt-16 text-center text-gray-400
          ...
          <p>
            ...
            <span className="text-cyan-300 font-semibold">Supersalud</span>,{' '}
            y aplicaciones móviles empresariales.
          </p>
        </div>
      </div>
  );
